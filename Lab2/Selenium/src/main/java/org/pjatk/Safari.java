...
public class Safari {
    ...
    public void trojmiasto() {
        ...
        try {
            ...
            WebElement firstArticleLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//article//a)[1]")));

            // Scroll the element into view
            ((JavascriptExecutor) webDriver).executeScript("arguments[0].scrollIntoView(true);", firstArticleLink);
    ...
    public void supersklep() {
        ...
        try {
            ...
            WebElement chooseProduct = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"variant_0\"]")));
            chooseProduct.click();
